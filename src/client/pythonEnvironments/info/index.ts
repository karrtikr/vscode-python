 ...
 */
export function normalizeEnvironment(interp: PartialPythonEnvironment): void {
...
export function areSameEnvironment(
    interp1: PartialPythonEnvironment | undefined,
    interp2: PartialPythonEnvironment | undefined,
    fs: IFileSystem
): boolean {
    if (!interp1 || !interp2) {
        return false;
 ...
 */
export function updateEnvironment(interp: PartialPythonEnvironment, other: PartialPythonEnvironment): void {
